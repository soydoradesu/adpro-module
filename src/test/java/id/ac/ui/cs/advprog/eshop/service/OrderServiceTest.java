...
public class OrderServiceTest {
    ...
    void setUp() {
        ...
        Order order1 = new Order("13652556-0128-4c07-6546-54eb1396679b",
                products,
                1708560000L,
                "Safira Sudrajat");
        orders.add(order1);
        Order order2 = new Order("7f9e15bb-4615-42f4-aebc-c3af385fb678",
                products,
                1708570006L,
                "Safira Sudrajat");
        orders.add(order2);
    ...
    void testUpdateStatusInvalidOrderId() {
        doReturn(null).when(orderRepository).findById("zezo");

        assertThrows(NoSuchElementException.class,
                () -> orderService.updateStatus("zezo", OrderStatus.SUCCESS.getValue()));
    ...
    void testFindByIdIfIdNotFound() {
        doReturn(null).when(orderRepository).findById("zezo");
        assertNull(orderService.findById("zezo"));
    }
